...
In our project we will also implement [PSP34](/OpenBrush/smart-contracts/PSP34) 
...
the [Ownable](/OpenBrush/smart-contracts/ownable) extension in our NFT. The mint and burn 
...
In addition to the dependencies imported in the [PSP34](/OpenBrush/smart-contracts/PSP34)
documentation, we will also add the `ownable` dependency the same way as in the
[ownable](/OpenBrush/smart-contracts/ownable) documentation. We will be using `LoanContract`
...
We want a basic [PSP34](/OpenBrush/smart-contracts/PSP34) token with metadata and ownable extensions, 
